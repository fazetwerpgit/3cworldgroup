              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-[#8dc63f] text-white py-4 rounded-lg font-bold text-lg hover:bg-[#7ab82e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
            ...
            <ScrollReveal direction="right" delay={200}>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-3">
                  <a href="#" aria-label="Facebook" className="w-10 h-10 bg-[#6A8FE3] rounded-lg flex items-center justify-center text-white hover:bg-[#5578c9] transition-all shadow-md">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z"/>
                    </svg>
                  </a>
                  <a href="#" aria-label="Instagram" className="w-10 h-10 bg-[#8dc63f] rounded-lg flex items-center justify-center text-white hover:bg-[#7ab82e] transition-all shadow-md">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="#" aria-label="LinkedIn" className="w-10 h-10 bg-[#6A8FE3] rounded-lg flex items-center justify-center text-white hover:bg-[#5578c9] transition-all shadow-md">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="#" aria-label="Twitter" className="w-10 h-10 bg-[#8dc63f] rounded-lg flex items-center justify-center text-white hover:bg-[#7ab82e] transition-all shadow-md">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
